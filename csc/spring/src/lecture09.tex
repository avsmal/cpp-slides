...
%Exceptions provide a formal, well-defined way for code that detects errors to pass the information up the call stack.
%Исключение — объект, содержащий описание ошибки,
%который передаётся от места её возникновения к месту обработки.
